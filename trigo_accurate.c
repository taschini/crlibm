/*
 * SCS trigonometric functions
 *
 * Author : Defour David, Daramy Catherine, Florent de Dinechin for the cleanup
 *
 * This file is part of the crlibm library which is distributed under the LGPL.
 * 
 */
#include <stdio.h>
#include <stdlib.h>
