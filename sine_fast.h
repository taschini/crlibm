...
#define DEG_SIN 17
#define DEG_COS 18
#define MAX_FAST_SIN 6.588397316661142069628409496531e+06
#define MIN_RETURN_X_FOR_SINE  1.49e-8
#define MINY_ACCURATE 2.000000000000000000000000000000e+00 
#define RND_CST 1.02 
#ifdef WORDS_BIGENDIAN
db_number const pio2hi = {{0x3FF921FB,0x54400000}} /* +1.5707963267e+00 */ ;
db_number const pio2med = {{0x3DD0B461,0x1A000000}} /* +6.0771004982e-11 */ ;
db_number const pio2lo = {{0x3BF898CC,0x51701B84}} /* +8.3337429185e-20 */ ;
...
#else
db_number const pio2hi = {{0x54400000,0x3FF921FB}} /* +1.5707963267e+00 */ ;
db_number const pio2med = {{0x1A000000,0x3DD0B461}} /* +6.0771004982e-11 */ ;
db_number const pio2lo = {{0x51701B84,0x3BF898CC}} /* +8.3337429185e-20 */ ;
