...
/* some bounds */ 
  db_number const max_input_ch = {{0x408633CE,0x8FB9F87E}};     /*7.1047586007e+02*/  
  db_number const max_input_sh = {{0x408633CE,0x8FB9F87E}};     /*7.1047586007e+02*/  
  db_number const round_cst_cosh = {{0x3FF00831,0x26E978D5}};     /*1.0020000000e+00*/  
  db_number const round_cst_sinh = {{0x3FF00831,0x26E978D5}};     /*1.0020000000e+00*/  
...
/* the coefficients for the cosh-approximations */ 
  ...
  db_number const c2 =   {{0x3FE00000,0x00000000}};     /*5.0000000000e-01*/  
  db_number const c4 =   {{0x3FA55555,0x55555555}};     /*4.1666666667e-02*/  
  db_number const c6 =   {{0x3F56C16C,0x16C16C17}};     /*1.3888888889e-03*/  
  db_number const c8 =   {{0x3EFA01A0,0x1A01A01A}};     /*2.4801587302e-05*/  
/* the coefficients for the sinh-approximations */
  db_number const s1 =   {{0x3FF00000,0x00000000}};     /*1.0000000000e+00*/  
  db_number const s3 =   {{0x3FC55555,0x55555555}};     /*1.6666666667e-01*/  
  db_number const s5 =   {{0x3F811111,0x11111111}};     /*8.3333333333e-03*/  
  db_number const s7 =   {{0x3F2A01A0,0x1A01A01A}};     /*1.9841269841e-04*/  
#else  
...
/* some bounds */ 
  db_number const max_input_ch = {{0x8FB9F87E,0x408633CE}};     /*7.1047586007e+02*/  
  db_number const max_input_sh = {{0x8FB9F87E,0x408633CE}};     /*7.1047586007e+02*/  
  db_number const round_cst_cosh = {{0x26E978D5,0x3FF00831}};     /*1.0020000000e+00*/  
  db_number const round_cst_sinh = {{0x26E978D5,0x3FF00831}};     /*1.0020000000e+00*/  
static const db_number cosh_sinh_table[179][4] = { 
...
/* the coefficients for the cosh-approximations */ 
  ...
  db_number const c2 =   {{0x00000000,0x3FE00000}};     /*5.0000000000e-01*/  
  db_number const c4 =   {{0x55555555,0x3FA55555}};     /*4.1666666667e-02*/  
  db_number const c6 =   {{0x16C16C17,0x3F56C16C}};     /*1.3888888889e-03*/  
  db_number const c8 =   {{0x1A01A01A,0x3EFA01A0}};     /*2.4801587302e-05*/  
/* the coefficients for the sinh-approximations */
  db_number const s1 =   {{0x00000000,0x3FF00000}};     /*1.0000000000e+00*/  
  db_number const s3 =   {{0x55555555,0x3FC55555}};     /*1.6666666667e-01*/  
  db_number const s5 =   {{0x11111111,0x3F811111}};     /*8.3333333333e-03*/  
  db_number const s7 =   {{0x1A01A01A,0x3F2A01A0}};     /*1.9841269841e-04*/  
#endif  
