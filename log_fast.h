...
#define MIN_FASTPATH 128.500 
/* Constants for rounding  */
double const delta[4] =
{
  /* Case E=0  */
  4.33600688246032171975889299866952645276896320476974e-18, 
  /* Middle case   */
  7.77153958753049900752248594900842916740839905338556e-19, 
  /* Case E>24  */
  2.95430398068072105552767110828704713759459047001942e-20, 
  /* And for the fast path  */
  1.26600328615147262831424171059564027818517046590697e-19 
...
{
  /* Case E=0  */
  1.08331792631519685521368501213146373629570007324219e+00, 
  /* Middle case   */
  1.01411019703049998241795037756673991680145263671875e+00, 
  /* Case E>24  */
  1.00053246008253626797568358597345650196075439453125e+00, 
  /* And for the fast path  */
  1.00228509184110703422732058243127539753913879394531e+00 
};
