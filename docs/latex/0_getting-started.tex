...
In the sequel $x$ and $y$ are of type $double$ and every function
return a double precision number. For trigonometric functions the
angles are express in radian.
\begin{center}
