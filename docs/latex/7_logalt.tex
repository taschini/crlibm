...
bound theorems given in \cite{Lau05}. Here, we understand by ``propagating'' checking a system of constraints 
...
\begin{lstlisting}[caption={Triple-double computations},firstnumber=90]
