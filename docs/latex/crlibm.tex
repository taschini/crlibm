...
\item All the people who have reported bugs, hoping that they continue
  until they have to stop: Evgeny Gvozdev from Intel with special thanks, Christoph Lauter
  from TUMünchen, Eric McIntosh from CERN, Patrick Pelissier and
...
\chapter{The portable SCS-free implementation of the natural logarithm \label{chap:log}}
\input{7_logalt.tex}
