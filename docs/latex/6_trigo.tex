...
Again we may compute the value of $\maxeps_{\mathrm{sinkzero}}$ as an infinite norm under Maple.
...
$\hat{y}=x-k\pi/256$ with an absolute accuracy $\delta_{\mathrm{argred}}$: 

$$y_h+y_l = (x-k\pi/256) + \delta_{\mathrm{argred}} $$
