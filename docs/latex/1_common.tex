...
Let $y$ be a real number, and  $\maxeps$, $e$, $y_h$ and $y_l$ be
  ...
  \item $|y_h|\ge 2^{-1022+53}$ (i.e. $\frac{1}{2}\ulp(y_h)$ is not subnormal), 
...
\begin{proof}
  ...
  From the first hypothesis we have $y_l\le\frac{1}{2}u$.
  ...
  From $\maxeps<2^{-55}$ (fifth hypothesis) we derive $\maxeps y <
  2^{-55}y < \frac{1}{2}u$, which in turn implies $y<2^{53}u$ (as  
  $y < y_h + y_l +\maxeps y < (2^{53}-1)u +\frac{1}{2}u
  +\frac{1}{2}u$).

  First we consider the case when $y_h$ is not a power of two.  In
  ...
  \frac{1}{2^{k+1}})u$.  Remark that the condition $|y_h|\ge
  2^{-1022+53}$ ensures that $\frac{1}{2}u$ is a normal number, so in
