...
completed. This worst-case accuracy is $118$ bits according to Lefèvre
and Muller \cite{LefMul2004}.

We therefore proceed in two phases \cite{Ziv91}.  The first, quick
phase (program \texttt{log\_fast.c}) is accurate only to $2^57$ and $2^64$,
...
bits using the SCS library is launched (program \texttt{log\_accurate.c}).
